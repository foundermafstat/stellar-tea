...
export declare const networks: {
    readonly testnet: {
        ...
        readonly contractId: "CDG3NFNDNP5ISU53A2RKMSSFQWFDK35UTKUAPR32ZGJD6YAPYRWVCJIE";
    };
};
export type DataKey = {
    tag: "Admin";
...
export interface Client {
     ...
     */
    update_contract_metadata: ({ base_uri, name, symbol, }: {
     ...
     */
    set_metadata: ({ caller, token_id, tea_metadata, }: {
        caller: string;
        token_id: u64;
        tea_metadata: TeaMetadata;
    }, options?: {
     ...
     */
    set_level: ({ caller, token_id, new_level, }: {
        caller: string;
        token_id: u64;
        new_level: u32;
    }, options?: {
     ...
     */
    set_lineage: ({ caller, token_id, lineage, }: {
        caller: string;
        token_id: u64;
        lineage: Array<u64>;
    }, options?: {
     ...
     */
    burn_token: ({ caller, owner, token_id, }: {
        caller: string;
        owner: string;
        token_id: u64;
    }, options?: {
...
export declare class Client extends ContractClient {
    ...
    readonly fromJSON: {
        ...
        game_operator: (json: string) => AssembledTransaction<Option<string>>;
        set_game_operator: (json: string) => AssembledTransaction<null>;
        update_contract_metadata: (json: string) => AssembledTransaction<null>;
        mint: (json: string) => AssembledTransaction<bigint>;
        get_metadata: (json: string) => AssembledTransaction<TeaMetadata>;
        set_metadata: (json: string) => AssembledTransaction<null>;
        set_level: (json: string) => AssembledTransaction<null>;
        set_lineage: (json: string) => AssembledTransaction<null>;
        burn_token: (json: string) => AssembledTransaction<null>;
