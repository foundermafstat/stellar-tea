...
export const networks = {
  testnet: {
    ...
    contractId: "CCCIQA7KQ36QNJQKPDG7Q4JB3ERZQL3RAACLMD6W755YGDIEQSPN446A",
  },
} as const;
...
export interface Client {
  ...
  approve: (
    {
      ...
      amount,
      expiration_ledger,
    }: { from: string; spender: string; amount: i128; expiration_ledger: i128 },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
  ...
  /**
   * Construct and simulate a burn_by_admin transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  burn_by_admin: (
    { from, amount }: { from: string; amount: i128 },
    options?: {
  ...
  metadata: (options?: {
     ...
     */
    simulate?: boolean;
  }) => Promise<AssembledTransaction<readonly [u32, string, string]>>;
}
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([
        ...
        "AAAAAAAAAAAAAAANX19jb25zdHJ1Y3RvcgAAAAAAAAEAAAAAAAAADWFkbWluX2FkZHJlc3MAAAAAAAATAAAAAA==",
        "AAAAAAAAAAAAAAAJc2V0X2FkbWluAAAAAAAAAQAAAAAAAAAJbmV3X2FkbWluAAAAAAAAEwAAAAA=",
        "AAAAAAAAAAAAAAAHYmFsYW5jZQAAAAABAAAAAAAAAAJpZAAAAAAAEwAAAAEAAAAL",
        "AAAAAAAAAAAAAAAIdHJhbnNmZXIAAAADAAAAAAAAAARmcm9tAAAAEwAAAAAAAAACdG8AAAAAABMAAAAAAAAABmFtb3VudAAAAAAACwAAAAA=",
        "AAAAAAAAAAAAAAANdHJhbnNmZXJfZnJvbQAAAAAAAAQAAAAAAAAAB3NwZW5kZXIAAAAAEwAAAAAAAAAEZnJvbQAAABMAAAAAAAAAAnRvAAAAAAATAAAAAAAAAAZhbW91bnQAAAAAAAsAAAAA",
        "AAAAAAAAAAAAAAAHYXBwcm92ZQAAAAAEAAAAAAAAAARmcm9tAAAAEwAAAAAAAAAHc3BlbmRlcgAAAAATAAAAAAAAAAZhbW91bnQAAAAAAAsAAAAAAAAAEWV4cGlyYXRpb25fbGVkZ2VyAAAAAAAACwAAAAA=",
        ...
        "AAAAAAAAAAAAAAANYnVybl9ieV9hZG1pbgAAAAAAAAIAAAAAAAAABGZyb20AAAATAAAAAAAAAAZhbW91bnQAAAAAAAsAAAAA",
        "AAAAAAAAAAAAAAAIbWV0YWRhdGEAAAAAAAAAAQAAA+0AAAADAAAABAAAABAAAAAQ",
  ...
  public readonly fromJSON = {
    ...
    burn_by_admin: this.txFromJSON<null>,
    metadata: this.txFromJSON<readonly [u32, string, string]>,
  };
}
