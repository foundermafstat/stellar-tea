...
export class Client extends ContractClient {
  ...
  fromJSON = {
    ...
    game_operator: this.txFromJSON,
    set_game_operator: this.txFromJSON,
    update_contract_metadata: this.txFromJSON,
    mint: this.txFromJSON,
    get_metadata: this.txFromJSON,
    set_metadata: this.txFromJSON,
    set_level: this.txFromJSON,
    set_lineage: this.txFromJSON,
    burn_token: this.txFromJSON,
