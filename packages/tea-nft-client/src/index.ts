...
export const networks = {
  testnet: {
    ...
    contractId: "CDFRIVAZZEWIOIADFAFE3M7X7QJ5ZTOU53PLWLFBRAEP5SK4ENBYHKFE",
  },
} as const;

export type DataKey =
  | { tag: "Admin"; values: void }
  | { tag: "GameOperator"; values: void }
  | { tag: "Token"; values: readonly [u64] };
...
export interface Client {
  ...
  /**
   * Construct and simulate a game_operator transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  game_operator: (options?: {
    /**
     * The fee to pay for the transaction. Default: BASE_FEE
     */
    fee?: number;
  ...
  /**
   * Construct and simulate a set_game_operator transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  set_game_operator: (
  ...
  /**
   * Construct and simulate a update_contract_metadata transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  ...
  mint: (
    {
      ...
      to,
      tea_metadata,
    }: { caller: string; to: string; tea_metadata: TeaMetadata },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
  ...
  ) => Promise<AssembledTransaction<TeaMetadata>>;
  ...
  set_metadata: (
    {
      ...
      token_id,
      tea_metadata,
    }: { caller: string; token_id: u64; tea_metadata: TeaMetadata },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
  ...
  /**
   * Construct and simulate a set_level transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  set_level: (
    {
      caller,
      token_id,
      new_level,
    }: { caller: string; token_id: u64; new_level: u32 },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
  ...
  /**
   * Construct and simulate a set_lineage transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  set_lineage: (
    {
      caller,
      token_id,
      lineage,
    }: { caller: string; token_id: u64; lineage: Array<u64> },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
  ...
  /**
   * Construct and simulate a burn_token transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  burn_token: (
    {
      caller,
      owner,
      token_id,
    }: { caller: string; owner: string; token_id: u64 },
    options?: {
      /**
       * The fee to pay for the transaction. Default: BASE_FEE
       */
...
export class Client extends ContractClient {
  static async deploy<T = Client>(
    /** Constructor/Initialization Args for the contract's `__constructor` method */
    {
      admin_address,
      base_uri,
    }: { admin_address: string; base_uri: Option<string> },
    ...
    return ContractClient.deploy({ admin_address, base_uri }, options);
  }
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([
        "AAAAAgAAAAAAAAAAAAAAB0RhdGFLZXkAAAAAAgAAAAAAAAAAAAAABUFkbWluAAAAAAAAAAAAAAAAAAAMR2FtZU9wZXJhdG9y",
        "AAAAAgAAAAAAAAAAAAAAB0RhdGFLZXkAAAAAAQAAAAEAAAAAAAAABVRva2VuAAAAAAAAAQAAAAY=",
        ...
        "AAAAAAAAAAAAAAANX19jb25zdHJ1Y3RvcgAAAAAAAAIAAAAAAAAADWFkbWluX2FkZHJlc3MAAAAAAAATAAAAAAAAAAhiYXNlX3VyaQAAA+gAAAAQAAAAAA==",
        "AAAAAAAAAAAAAAAFYWRtaW4AAAAAAAAAAAAAAQAAABM=",
        "AAAAAAAAAAAAAAANZ2FtZV9vcGVyYXRvcgAAAAAAAAAAAAABAAAD6AAAABM=",
        "AAAAAAAAAAAAAAARc2V0X2dhbWVfb3BlcmF0b3IAAAAAAAABAAAAAAAAAAhvcGVyYXRvcgAAABMAAAAA",
        "AAAAAAAAAAAAAAAYdXBkYXRlX2NvbnRyYWN0X21ldGFkYXRhAAAAAwAAAAAAAAAIYmFzZV91cmkAAAPoAAAAEAAAAAAAAAAEbmFtZQAAA+gAAAAQAAAAAAAAAAZzeW1ib2wAAAAAA+gAAAAQAAAAAA==",
        "AAAAAAAAAAAAAAAEbWludAAAAAMAAAAAAAAABmNhbGxlcgAAAAAAEwAAAAAAAAACdG8AAAAAABMAAAAAAAAADHRlYV9tZXRhZGF0YQAAB9AAAAALVGVhTWV0YWRhdGEAAAAAAQAAAAY=",
        "AAAAAAAAAAAAAAAMZ2V0X21ldGFkYXRhAAAAAQAAAAAAAAAIdG9rZW5faWQAAAAGAAAAAQAAB9AAAAALVGVhTWV0YWRhdGEA",
        "AAAAAAAAAAAAAAAMc2V0X21ldGFkYXRhAAAAAwAAAAAAAAAGY2FsbGVyAAAAAAATAAAAAAAAAAh0b2tlbl9pZAAAAAYAAAAAAAAADHRlYV9tZXRhZGF0YQAAB9AAAAALVGVhTWV0YWRhdGEAAAAAAA==",
        "AAAAAAAAAAAAAAAJc2V0X2xldmVsAAAAAAAAAwAAAAAAAAAGY2FsbGVyAAAAAAATAAAAAAAAAAh0b2tlbl9pZAAAAAYAAAAAAAAACW5ld19sZXZlbAAAAAAAAAQAAAAA",
        "AAAAAAAAAAAAAAALc2V0X2xpbmVhZ2UAAAAAAwAAAAAAAAAGY2FsbGVyAAAAAAATAAAAAAAAAAh0b2tlbl9pZAAAAAYAAAAAAAAAB2xpbmVhZ2UAAAAD6gAAAAYAAAAA",
        "AAAAAAAAAAAAAAAKYnVybl90b2tlbgAAAAAAAwAAAAAAAAAGY2FsbGVyAAAAAAATAAAAAAAAAAVvd25lcgAAAAAAABMAAAAAAAAACHRva2VuX2lkAAAABgAAAAA=",
  ...
  public readonly fromJSON = {
    ...
    game_operator: this.txFromJSON<Option<string>>,
    set_game_operator: this.txFromJSON<null>,
    update_contract_metadata: this.txFromJSON<null>,
    mint: this.txFromJSON<u64>,
    get_metadata: this.txFromJSON<TeaMetadata>,
    set_metadata: this.txFromJSON<null>,
    set_level: this.txFromJSON<null>,
    set_lineage: this.txFromJSON<null>,
    burn_token: this.txFromJSON<null>,
